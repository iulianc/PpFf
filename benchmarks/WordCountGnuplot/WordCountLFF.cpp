...
int main(int argc, char* argv[]) {
    ...
    int blockSize = argc >= 3 ? atoi(argv[2]) : DEFAULT_BLOCK_SIZE;
    std::string inputFile = argc >= 4 ? argv[3] : DEFAULT_INPUT_FILE;


    // Utilisé pour vérifier le bon fonctionnement du programme
    bool emitOutput = argc >= 5 && atoi(argv[4]) == 1;
