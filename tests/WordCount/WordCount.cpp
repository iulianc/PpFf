...
//    								}))
    ...
    std::cout << "Duration nanoseconds: " << duration_ns / iterations << "ns." << std::endl;
    std::cout << "Duration microseconds: " << duration_us / iterations << "us." << std::endl;
	std::cout << "Duration milliseconds: " << duration_ms / iterations << "ms." << std::endl;
