...
\chapter{Logiciels et bibliothèques de traitement de flux de donn\'ees~: \TT{Spark}, \TT{Java}, \TT{FastFlow} et autres bibliothèques \TT{C++}}
\label{outils_connus}
...
\section{Autres biblioth\`eques \TT{C++}}
