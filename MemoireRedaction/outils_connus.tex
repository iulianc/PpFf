...
%
Le mod\`ele \TT{D-stream} est une abstraction de \TT{Spark}. Il s'agit essentiellement d'un flux de RDD dont les \'el\'ements sont les donn\'ees re\c cues par flux en entr\'ee pour le traitement par lots.
%
