...
\centering
     \includegraphics[width=1.0\textwidth]{Figures/FastFlowLayers.jpg}
      \caption{Les couches de \TT{FastFlow}. \GT{Quand tu as une telle figure qui provient d'ailleurs, il faut indiquer explicitement la source, par exemple (mais pas certain que ce soit la bonne r\'ef\'erence: \`a v\'erifier!)}. Figure tir\'ee de \cite{AldinucciEtAl14}.}
