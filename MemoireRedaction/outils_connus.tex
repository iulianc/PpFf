...
\ACOMPLETER{Un \emph{flux de donn\'ees} --- au sens de \emph{data
stream} --- \ldots\ }
...
Le traitement de flux de donn\'ees repr\'esente la conversion des donn\'ees en entr\'ee du flux sous une forme utilisable et souhait\'ee. Cette conversion s'effectue \`a l'aide d'une s\'equence d'op\'erations pr\'ed\'efinie. Les op\'erations courantes de traitement de flux des donn\'ees comprennent le tri, le calcul, le filtrage et la transformation des donn\'ees. Les traitements de flux de donn\'ees peuvent \^etre group\'es dans deux grandes cat\'egories : le traitement de donn\'ees par lot (batch en anglais) et le traitement de donn\'ees en ligne de fa\c con incr\'ementale, au fur et \`a mesure o\`u ces donn\'ees deviennent disponibles. Alors que le mod\`ele de traitement par lots n\'ecessite que les donn\'ees soient collect\'ees au fil du temps, le traitement en continu n\'ecessite que les donn\'ees soient introduites dans le flux en temps r\'eel.
