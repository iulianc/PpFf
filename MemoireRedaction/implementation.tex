...
\GT{Dans un des rapports, il etait indique <<Les metriques de code
presentees (nombre de lignes, etc.) ne sont pas pertinentes si elles
ne sont pas discutees.>> Or, pour l'instant, je ne sais pas trop quel
genre de discussion tu pourrais/devrais faire. Une possibilite si on
