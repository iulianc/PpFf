...
%
\footnote{Politique \emph{round robin}~: \GT{Dire quelques mots sur ce que cela signifie.}}
%
...
\begin{itemize}
	\item  \TT{linesFromFile}, qui g\'en\`ere un flux s\'equentiel de lignes \`a partir d'un fichier --- le fichier est identifi\'e par le param\`etre \TT{path} fourni en argument;
