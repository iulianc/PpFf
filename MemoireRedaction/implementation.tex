...
\GT{Dans un des rapports, il était indiqué <<Les métriques de code
présentées (nombre de lignes, etc.) ne sont pas pertinentes si elles
ne sont pas discutées.>> Or, pour l'instant, je ne sais pas trop quel
