...
\GT{L'utilisation d'une représentation intermédiaire n'a rien à voir
avec l'ajout de fonctionnalités, donc j'ai supprimé cette partie de
phrase.}
...
\GT{La représentation intermédiaire n'est pas exécutée mais traitée,
parcourue, pour produire le graphe FastFlow.}
...
\GT{Ici, il faut te limiter aux aspects plus spécifiques à la mise en
oeuvre, pas aux aspects plus <<philosophiques>>, qui doivent avoir été
traités dans les chapitres initiaux. Donc, j'ai supprimé la 1ere
phrase.}
...
%
% GT: La phrase suivante ne me semble pas juste, ou à tout le moins pas claire sans explications additionnelles.  Donc, on va simplement l'omettre.
