...
\GT{Ci-haut: Cela (les \'equations avec WS et O) ne me semble pas
tr\`es clair \frownie 
%
On ne comprend pas trop le lien entre WS et O!  Dans le cas du
parall\'elisme de t\^aches, c'\'etait plus clair \`a cause de la
figure, o\`u on voyait un lien entre $W_i$ et $O_i$.}

\IC{J'ai ajout\'e une image. Je ne sais pas si c'est un peu plus clair.}
