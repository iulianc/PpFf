...
m\'ethode \TT{linesFromFile()} qui permet d'extraire et retourner dans
...
\hline
	...
	\end{tabular} &
  	\TT{Flux\&} &
    Produit un flux avec les \'el\'ements du conteneur.  \GT{Je ne comprends pas. Cela me semble incomplet comme explications.}
    \\
\hline
	\begin{tabular}{@{}l@{}}
	\tt template<T> \\
...
\hline
    ...
    \\
\hline
	\multicolumn{3}{|c|}{M\'ethode pour l'ex\'ecution concurrente flux}
    \\      
\hline
	\begin{tabular}{@{}l@{}}
