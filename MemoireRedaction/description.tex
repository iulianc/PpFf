...
\endfirsthead
\multicolumn{3}{c}%
{\tablename\ \thetable\ -- \textit{Suite de la page pr\'ec\'edente}} \\
\hline
\textbf{M\'ethode} & \textbf{Type du r\'esultat} & \textbf{Description du r\'esultat}\\
\hline
\endhead
\hline \multicolumn{3}{r}{\textit{Suite \`a la page suivante}} \\
\endfoot
\hline
\endlastfoot
\hline
...
\hline
    ...
    Renvoie dans le flux les \'el\'ements du conteneur Container.  
    \\
\hline
	\begin{tabular}{@{}l@{}}
...
\hline
	...
	\end{tabular} &
	\texttt{T} &
	Retourne l'\'el\'ement maximum de ce flux en fonction du comparateur fourni en param\`etre.
    \\
\hline
	\begin{tabular}{@{}l@{}}
	\tt template<T> \\
	...
	\end{tabular} &
	\texttt{T} &
	Retourne l'\'el\'ement minimum de ce flux en fonction du comparateur fourni en param\`etre.
    \\
\hline
	\begin{tabular}{@{}l@{}}
	\tt template<T> \\
...
\hline
	...
	\end{tabular} &
	Pipe\& &
	M\'ethode utilis\'ee pour d\'ebogage. Applique une fonction sur les \'el\'ements de ce flux sans modifier leur valeur.
    \\
\hline
	\begin{tabular}{@{}l@{}}
...
%
Lorsque la fonction (lambda-expression) fournie en argument \`a la m\'ethode \texttt{find} ne satisfait pas la condition lorqu'appliqu\'ee \`a un \'el\'ement du flux, le filtre ne retourne rien. 
