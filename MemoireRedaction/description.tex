...
\TT{FastFlow} est une biblioth\`eque de base niveau qui permet de traiter des collections de donn\'ees. Travailler avec des collections n'est pas toujours facile. Par exemple, supposons que dans une universit\'e nous devons filtrer les \'etudiants boursiers ayant une moyenne d'A, puis les regrouper par d\'epartement. Le listing (\`A ajouter un FastFlow exemple) montre cet exemple impl\'ement\'e dans \TT{FastFlow}. On peut observer que pour chaque op\'eration dans le flux on doit cr\'eer une nouvelle fonctionnalit\'e. De plus, il est difficile de comprendre d'un coup d'œil ce que fait le code. Les op\'erations sont d'abord d\'efinies dans diff\'erents nœuds et ensuite leurs r\'ef\'erences sont utilis\'ees dans la cr\'eation du flux. 

Dans \TT{PpFf} ce probl\`eme peut \^etre r\'esolu en utilisant le chainage de m\'ethodes. \TT{PpFf} propose de nombreuses m\'ethodes pr\'ed\'efinies pour les op\'erations de traitement de flux les plus utilis\'ees. Le listing (\`A ajouter un PpFf exemple) montre l'exemple du listing (\`A ajouter ref vers l'exemple FastFlow), mais r\'e\'ecrit dans \TT{PpFf}. On peut observer que, le code est plus facile \`a comprendre. Les op\'erations sont d\'eclar\'ees \`a la cr\'eation du flux. De plus le nombre de lignes de code utilis\'e dans \TT{PpFf} est consid\'erablement r\'eduit comparatif \`a \TT{FastFlow}. 
...
Un probl\`eme bien connu en g\'enie logiciel est que, les besoins des utilisateurs changent assez souvent. Il est difficile d'\'ecrire du code capable de faire face \`a l'\'evolution des exigences. Par exemple, si on prend l'exemple du listing (\`A ajouter ref \`a l'exemple FastFlow) ou dans une universit\'e on a filtr\'e seulement les \'etudiants boursiers ayant une moyenne d'A. Que se passe-t-il si un autre jour on veut filtrer les \'etudiants qui habite dans une certaine ville ? Dans \TT{FastFlow}, une solution sera d'impl\'ementer une nouvelle fonctionnalit\'e dans un autre nœud et utiliser sa r\'ef\'erence dans la cr\'eation du flux autant de fois que n\'ecessaire. 

Passer des fonctionnalit\'es comme r\'ef\'erence c'est utile, mais c'est un peu ennuyeux d'avoir \`a \'ecrire une d\'efinition pour des fonctionnalit\'es simples dans les conditions o\`u elles ne sont peut-\^etre utilis\'ees qu'une ou deux fois. Id\'ealement, on souhaite minimiser les efforts de d\'eveloppeurs et offrir des fonctionnalit\'es simples \`a mettre en œuvre et \`a maintenir \`a long terme. 

\TT{PpFf} offre la possibilit\'e d'utiliser les expressions \emph{lambda} directement dans la cr\'eation du flux. (À donner un exemple). On peut observer que dans \TT{PpFf}, il n'y a pas n\'ecessaire d'\'ecrire une nouvelle d\'efinition pour la fonctionnalit\'e qui n'est utilis\'ee qu'une seule fois. Le code est plus clair et plus concis.
