...
\IC{Le texte est correct. PpFf est plus performant que Java sur la machine M2 et moi performant sur les deux autres machines.}
...
\IC{J'ai modifié le texte en fonction des nouveaux résultats.}
