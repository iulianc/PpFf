...
Cette application est compos\'ee en un pipeline combinant cinq principales op\'erations~: 
...
\item La troisi\`eme op\'eration,  \TT{map}, permet d'extraire le nom et les donn\'ees de chaque action du march\'e boursier.

\GT{En fait, que contient un enregistrement: les infos sur une action
sp\'ecifique? Ou une transaction boursi\`ere? \`A clarifier!}

\item  Le prix de chaque action est calcul\'e dans la quatri\`eme op\'eration. L'algorithme utilis\'e est \TT{Black \& Scholes}~\cite{XSX}. 
