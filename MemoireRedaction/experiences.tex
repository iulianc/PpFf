...
\IC{J'ai aussi mentionné la version séquentielle de Java.}

Chaque s\'erie d'exp\'eriences finales inclut les versions s\'equentielles pour les programmes compar\'es des deux biblioth\`eques. Identifi\'ees sur les graphes par \TT{Seq} la version s\'equentielle de \TT{PpFf} et \TT{Java} la version s\'equentielle avec warm-up de \TT{Java}, ces versions utilisent les m\^emes fonctions auxiliaires que les versions parall\`eles, mais s'ex\'ecutent de fa\c{c}on s\'equentielle. Ces programmes s\'equentiels ont aussi \'et\'e utilis\'e pour d\'eterminer les acc\'el\'erations. Le concept d'acc\'el\'eration d\'etermine \`a quel point un programme parall\`ele est plus rapide qu'un programme s\'equentiel \'equivalent. On distingue deux types d'acc\'elérations : relative ou absolue. Dans nos mesures, nous avons utilis\'e l'acc\'el\'eration \emph{absolue}. L'acc\'el\'eration absolue compare le programme ex\'ecut\'e sur une machine multiprocesseurs avec le meilleur programme s\'equentiel qui r\'esout le m\^eme probl\`eme. 
...
\GT{Maintenant, il faut conclure avec des idées plus générales, par
exemple, en tirant des conclusions des dernières séries
d'expérimentations. Du genre: la décomposition en étages est
importante et utile, mais il faut s'assurer que le travail fait par un
étage soit assez gros, sinon les surcoûts du parallélisme deviennent
trop grands.}

\IC{J’ai ajouté quelques mots pour résumer le chapitre 4.}

Dans ce chapitre plusieurs exp\'eriences ont \'et\'e men\'ees pour tester les performances de \TT{PpFf}. Dans la premi\`ere partie de ce chapitre deux applications utilisant la bibliothèque \TT{PpFf} ont \'et\'e compar\'e avec des programmes Java \'equivalentes utilisant les \TT{Streams} introduits en Java 8.0. Les valeurs pour les unit\'es de mesures – le temps d'ex\'ecution, le d\'ebit et l'acc\'elération - ont servi comme r\'ef\'erence pour comparer ces programmes. Les r\'esultats de la plupart des exp\'eriences ont montr\'e que \TT{Java} se comporte mieux que \TT{PpFf}.

Dans la derni\`ere section de ce chapitre, la section~\ref{autres-experiences-wordcount.sect}, d'autres exp\'eriences ont \'et\'e men\'ees pour comparer les diff\'erentes versions du programme \TT{WordCount}, versions cr\'e\'ees enti\`erement \`a l'aide de la biblioth\`eque \TT{PpFf}. Ces exp\'eriences ont montr\'e que \TT{PpFf} reste une biblioth\`eque assez efficace.

Un programme cr\'e\'e en utilisant la biblioth\`eque \TT{PpFf} peut \^etre d\'ecompos\'e en diff\'erents \'etages (\'etapes), \'etages qui repr\'esentent les op\'erations dans la cha\^ine de traitement de la biblioth\`eque. Con\c{c}u dans un style fonctionnel, \TT{PpFf} permet de d\'ecomposer un programme en tr\`es fines t\^aches. La taille de cette t\^ache ou la granularit\'e qui repr\'esente le travail dans un \'etage influence fortement les temps d'ex\'ecution de l'application. Les r\'esultats des exp\'eriences de la section~\ref{autres-experiences-wordcount.sect} ont montr\'e que si la granularit\'e est fine, l'application est moins performante. 

La d\'ecomposition en \'etages est importante et utile, mais il faut s'assurer que le travail fait par un \'etage soit assez gros, sinon les surco\^uts du parall\'elisme deviennent trop grands.
