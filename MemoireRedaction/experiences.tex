...
Dans ce chapitre, plusieurs exp\'eriences ont \'et\'e présentées dans le but d'évaluer les performances de \TT{PpFf}. Dans la premi\`ere partie de ce chapitre, deux applications utilisant la bibliothèque \TT{PpFf} ont \'et\'e compar\'ees avec des programmes Java \'equivalents utilisant les \TT{Streams} introduits en Java 8. Diverses unit\'es de mesures --– temps d'ex\'ecution, d\'ebit et acc\'elération --- ont servi comme r\'ef\'erence pour comparer ces programmes. Les r\'esultats de la plupart des exp\'eriences ont montr\'e que \TT{Java} se comporte mieux que \TT{PpFf}. 
%
D'autres exp\'eriences ont aussi \'et\'e faites pour comparer \TT{PpFf} avec \TT{FastFlow}. Les r\'esultats de ces exp\'eriences ont montr\'e que les surco\^uts introduits par \TT{PpFf} sont peu \'elev\'es.
