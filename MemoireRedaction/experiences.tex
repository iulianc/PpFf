...
%
Par contre, dans le cas de \TT{Java}, l'objectif était de comparer trois versions~: \GT{décrire brièvement ces trois versions}.
%
...
%
% GT: Ça se répète je trouvais.
%
% Ce m\'ecanisme permet donc de charger en m\'emoire toutes les
% classes, ce qui les rend accessibles plus rapidement pendant
% l'ex\'ecution d'exp\'eriences.
...
% Cela nous a permis d'avoir une meilleure visibilit\'e sur les
% performances obtenues par les trois programmes.
