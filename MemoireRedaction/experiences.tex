...
Afin de montrer les \'etapes des diverses exp\'eriences qui ont conduit aux r\'esultats finaux, l'annexe~\ref{ExperiencesPreliminairesWordCount.ann} pr\'esente un extrait d'un fichier de configuration \TT{WordCount-bm-config.rb}, utilis\'e pour l'ex\'ecution des expériences, alors ques les figures~\grapheref{WordCount-temps-java-2-10} et ~\grapheref{WordCount-log-temps-java-2-10} présentent quelques-uns des r\'esultats préliminaires obtenus.
