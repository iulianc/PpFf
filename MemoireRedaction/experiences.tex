...
La derni\`ere s\'erie d'exp\'eriences r\'ealis\'ees vise \`a comparer les acc\'el\'erations. Illustr\'ees sur la figure~\ref{WordCount-accs.fig}, les acc\'el\'erations d\'eterminent \`a quel point un programme parall\`ele est plus rapide qu'un programme s\'equentiel \'equivalent. En comparant les acc\'el\'erations du programme \TT{PpFf} avec celle de \TT{FastFlow}, on peut observer que, elles sont presque identiques. Cela d\'emontre une fois de plus que les surco\^uts introduits par \TT{PpFf} par rapport \`a \TT{FastFlow} sont n\'egligeables.  
...
Le code source des applications \TT{StockPrice} en \TT{PpFf} et~\TT{Java} est pr\'esent\'e dans les annexes~\ref{sourceCodeStockPricePpFf.ann} et~\ref{sourceCodeStockPriceJava.ann} respectivement. 
