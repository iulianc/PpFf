...
\GT{Pour la machine java (\M1, n'est-ce pas?), il faut mettre à jour
les caractéristiques, car les résultats qui sont présentés sont pour
les expériences réalisées après l'installation de la nouvelle version
de java.labunix.uqam.ca, différente de l'ancienne.}
...
\GT{Il faudrait vérifier à nouveau si le texte ci-bas, qui dit quand
PpFF est plus/moins rapide que Java/FastFlow, est toujours correct par
rapport aux nouveaux résultats.}
...
Dans cette section, nous \'evaluons l'application \TT{StockPrice} en examinant le temps d'ex\'ecution et le d\'ebit sur les trois machines : \M1, \M2 et \M3. 
