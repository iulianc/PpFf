...
% \usepackage[applemac]{inputenc} % Pour utiliser les caractères accentués sous MacOS
%%%%%%%%%%%%%%%%%%%
...
\usepackage{listings} %% Voir macros.tex pour les defauts en C++.
...
% \usepackage{natbib}
\setcounter{secnumdepth}{3} %Pour subsubsection
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
