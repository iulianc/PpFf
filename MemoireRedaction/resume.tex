...
Afin de traiter de fa\c {c}on simple et efficace les flux de donn\'ees, ce m\'emoire propose \TT{PpFf}, une \emph{API} \TT{C++} simple, de style fonctionnelle, fond\'ee sur une approche <<diviser-pour-r\'egner>> mais non r\'ecursive.
%
