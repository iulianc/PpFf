...
Afin de traiter de fa\c{c}on simple et efficace les flux de donn\'ees, ce m\'emoire propose \TT{PpFf}, une biblithèque \TT{C++} avec une \emph{API} simple, de style fonctionnelle, fond\'ee sur une approche <<diviser-pour-r\'egner>> mais non r\'ecursive, qui permet de traiter des donn\'ees en flux incr\'emental, mais aussi des collections en lot (\emph{batch}).
%
